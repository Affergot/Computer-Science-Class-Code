...
def titleScreen():
        ...
        try:
            with open('Computer Science 2\Chapter 10\save1.json', 'r') as file:
                save1 = json.load(file)
        except FileNotFoundError:
            database = {}
            database["SaveFile"] = "Empty Save"
            with open('Computer Science 2\Chapter 10\save1.json', 'w') as fp:
        ...
        try:
            with open('Computer Science 2\Chapter 10\save2.json', 'r') as file:
                save2 = json.load(file)
        except FileNotFoundError:
            database = {}
            database["SaveFile"] = "Empty Save"
            with open('Computer Science 2\Chapter 10\save2.json', 'w') as fp:
                json.dump(database, fp)
        except KeyError:
            database = {}
            database["SaveFile"] = "Empty Save"
        ...
        try:
            with open('Computer Science 2\Chapter 10\save3.json', 'r') as file:
                save3 = json.load(file)
        except FileNotFoundError or KeyError:
            database = {}
            database["SaveFile"] = "Empty Save"
            with open('Computer Science 2\Chapter 10\save3.json', 'w') as fp:
                json.dump(database, fp)
        except KeyError:
            database = {}
            database["SaveFile"] = "Empty Save"
